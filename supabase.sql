...
-- لو عايز تصفير حسابك يدويًا (اختياري فقط):
-- update public.game_profiles
-- set cash=500000, net_worth=500000, rep=18, level=1, office=1, day=1,
-- owned='[]'::jsonb, stats='{"deals":0,"profit":0,"flips":0}'::jsonb,
-- loans='[]'::jsonb, rent_offers='[]'::jsonb
-- where username='اسمك';
